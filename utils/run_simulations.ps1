...
python runner.py -p data\vehicle_population2235.yaml -n manhattan8x8_100pc -stl ON -e 2
python runner.py -p data\vehicle_population2235.yaml -n manhattan8x8_100pc -stl ON -e 1 2